            ...
            <footer id={styles.footer_home}>
                <div className={`${styles.container} layout_guide`}>
                    <div id={styles.footer_icons}>
                        <img src="../imgs/Logo_footer.svg" alt="Logo do VhBurguer que contém como plano de fundo um hambúrguer." className={styles.logo_vhburguer_footer} />
                        <div id={styles.icons}>
                            <a href="">
                    ...
                    <hr id={styles.linha}></hr> {/* hr -> cria uma linha horizontal*/}
